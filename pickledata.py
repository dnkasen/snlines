...
################################################
# Use this code to compress the line list
# to a pickle file: kurucz.pkl
# Choose a reference temperature of your choice
# 
################################################
...
def main(linefile,pklfile):
    ...
    # read line list
    linedata = np.loadtxt(linefile, skiprows=2,
...
if __name__ == "__main__":
    ...
    linefile = "kurucz_lines_cd23.dat"
    pklfile = "kurucz.pkl"
